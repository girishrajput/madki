...
= 1.6.7 (13-07-2026) =
* Improved: Custom Profile buttons functionality updated
* New: Added ability to specify a template source post/page for Custom Profile
* New: new items copy content from the selected template
